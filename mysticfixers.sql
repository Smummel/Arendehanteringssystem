...
--
-- Värd: 127.0.0.1
-- Tid vid skapande: 11 apr 2025 kl 11:04
...
(32, '2025-04-07', 'Mystic Fixers strikes again!', 'RobloxScreenShot20241026_145824532.png', 'En man var fast i ett robloxspel, men vi fick ut honom! Kom ihåg, om du har några paranormala besvär, kontakta oss!');
...
CREATE TABLE `tickets` (
  ...
  `prioritet` varchar(63) NOT NULL DEFAULT 'Ingen'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `tickets` (`id`, `name`, `email`, `phone`, `plats`, `datum`, `description`, `image`, `status`, `prioritet`) VALUES
...
(41, 'Åke Åker', 'ake.aker@hotmail.com', '070 123 45 67', 'Grodgatan 6, Göteborg', '2025-04-15', 'Jag var ute och rastade hunden, när jag såg något mystiskt. Det var en man som gick upp och ner! Jag vet inte exakt hur det är möjligt, men hans ben gick i luften medan hans huvud gled över marken, det såg väldigt underligt ut. Förutom att han var upp och', 'upside down.jpg', 'Pågående utredning', 'Låg'),
(42, 'Tramaskus Palasmi', 'tramaskus.palasimi@yahoo.com', '000-000 00 00', 'Rakbladsvägen 1, Karlskrona', '0000-00-00', 'Jag tror att jag hittade en portal. Jag vet inte vad jag ska göra riktigt, borde jag gå in i den?', 'mqdefault.jpg', 'Nytt', 'Hög');
